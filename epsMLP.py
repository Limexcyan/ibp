...
HyperMask with Interval Bound Propagation needed some modifications due to adding epsilons.
"""
...
hyper_shapes_distilled` and the current statistics will be returned by the
    ...
    def __init__(self, n_in=1, n_out=1, hidden_layers=(10, 10),
                 ...
                 out_fn=None, verbose=True, epsilon=0.01):
        ...
        linear_shapes = epsMLP.weight_shapes(n_in=n_in, n_out=n_out,
    ...
    def forward(self, x, weights=None, distilled_params=None, condition=None):
        ...
        Returns:
            ...
            - **eps** (optional): output epsilon (for self.epsilon=0, eps=0)
        """
        ...
        for l in range(len(w_weights)):
            ...
            #print(f'W: {W.shape}|eps: {eps.shape}|hid: {hidden.shape}')
            eps = torch.abs(W) @ eps
